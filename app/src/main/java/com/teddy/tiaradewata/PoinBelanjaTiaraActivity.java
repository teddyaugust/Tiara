...
public class  PoinBelanjaTiaraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poin_belanja_tiara);

        //buka webnya
        webView = (WebView) findViewById(R.id.poin_belanja_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://toko.yuk-kunjungi.com/tiaradewatanews/category/poin-belanja/");
