...
public class  PromoTiaraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promo_tiara);

        //buka webnya
        webView = (WebView) findViewById(R.id.promo_tiara_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://toko.yuk-kunjungi.com/tiaradewatanews/category/promo-tiara/");
